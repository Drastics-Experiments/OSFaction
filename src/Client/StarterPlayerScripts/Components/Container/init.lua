...
function Container.__init(target, props) 
    ...
    local Gui = new"ScreenGui" {
        ...
        [children] = {
            new"Frame"{
                ...
                Size = UDim2.new(0.352, 0,0.518, 0),
                ...
                [children] = {
                    ...
                    new"TextButton" {
                        BackgroundColor3 = Color3.fromRGB(255, 255, 42),
                        Transparency = 0.9,
                        Position = UDim2.new(0.884, 0,0.048, 0),
                    ...
                    new"TextButton" {
                        ...
                        Transparency = 0.9,
                        Position = UDim2.new(0.938, 0,0.048, 0),
                        Size = UDim2.new(0, 24,0, 24),
    ...
    local GenUid; do -- Gnerate unique names for RenderStepped bindings
        local id = 0
        function GenUid()
            id = id + 1
